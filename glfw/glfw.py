...
def generate_wrappers(glfw_header: str) -> None:
    ...
    const char* glfwCocoaPreserveDroppedFilePromises(GLFWwindow *window)
    ...
    bool glfwWaylandTitlebarTabsRounded(GLFWwindow *handle)
    void glfwWaylandSetIMEInhibited(bool inhibited)
